        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <a href="#download" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium">Download App</a>
            </div>
          </div>
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#download" className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold text-lg">
                <i className="fas fa-mobile-alt mr-2"></i>
                Download Scheduled App
              </a>
              <a href="#demo" className="border-2 border-blue-600 text-blue-600 hover:bg-blue-50 px-8 py-4 rounded-lg font-semibold text-lg">
                Request Live Demo
              </a>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-pink-50 to-rose-50 p-8 rounded-xl border border-pink-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Beauty Professionals</h3>
              <p className="text-gray-600">Salon management, client history, service tracking, and automated marketing.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-orange-50 to-amber-50 p-8 rounded-xl border border-orange-100">
              ...
              <p className="text-gray-600">Project management, job estimation, material tracking, and client communication.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-8 rounded-xl border border-green-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Wellness Professionals</h3>
              <p className="text-gray-600">Health tracking, treatment plans, and wellness program management.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-xl p-8">
              ...
              <a href="#contact" className="w-full bg-gray-600 hover:bg-gray-700 text-white py-3 px-6 rounded-lg font-semibold text-center block">
                Start Professional
              </a>
            </div>

            {/* Enterprise */}
            <div className="bg-blue-600 text-white rounded-xl p-8 relative transform scale-105">
              ...
              <div className="text-4xl font-bold mb-6">$399<span className="text-lg text-blue-200">/month</span></div>
              <a href="#contact" className="w-full bg-white text-blue-600 hover:bg-gray-100 py-3 px-6 rounded-lg font-semibold text-center block">
                Start Enterprise
              </a>
            </div>
      ...
      <section id="download" className="py-16 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <a href="#" className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 rounded-lg font-semibold text-lg">
              <i className="fab fa-apple mr-2"></i>
              Download for iOS
            </a>
            <a href="#demo" className="border-2 border-white text-white hover:bg-white hover:text-blue-600 px-8 py-4 rounded-lg font-semibold text-lg">
              Request Demo
            </a>
          </div>
        </div>
