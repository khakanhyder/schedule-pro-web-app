...
>(({ side = "right", className, children, ...props }, ref) => {
  // Check if children contains SheetTitle and SheetDescription
  let hasTitle = false;
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        {...props}
      >
        {!hasTitle && <SheetTitle className="sr-only">Menu</SheetTitle>}
