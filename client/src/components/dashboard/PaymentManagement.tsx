...
export default function PaymentManagement() {
  ...
  const createPaymentRequest = () => {
    if (!newPaymentRequest.clientName || !newPaymentRequest.clientEmail || !newPaymentRequest.amount) {
      toast({
    ...
    const request: PaymentRequest = {
      ...
      clientName: newPaymentRequest.clientName,
      clientEmail: newPaymentRequest.clientEmail,
      amount: parseFloat(newPaymentRequest.amount),
      description: newPaymentRequest.description || 'Service Payment',
      status: 'pending',
      createdAt: new Date(),
      dueDate: new Date(newPaymentRequest.dueDate)
    };
    ...
    toast({
      ...
      description: "Multi-payment link is ready to send to client"
    });
  };
            ...
            <div className="space-y-4 p-4 bg-gray-50 rounded-lg mb-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    value={newPaymentRequest.clientName}
                    onChange={(e) => setNewPaymentRequest({ ...newPaymentRequest, clientName: e.target.value })}
                ...
                <div>
                  ...
                  <Input
                    type="email"
                    value={newPaymentRequest.clientEmail}
                    onChange={(e) => setNewPaymentRequest({ ...newPaymentRequest, clientEmail: e.target.value })}
